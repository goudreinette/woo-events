...
class EventUtils
{
     ...
     */
    public static function selectEventsByCategories($categories, $events)
    {
     ...
     * @return Filtered Array of events
     */
    public static function filterExpiredEvents($filter, $events)
    {
     ...
     */
    public static function isExpired($event)
    {
     ...
     */
    public static function sortEvents($events, $order)
    {
     ...
     */
    public static function prepareEvents($events)
    {
